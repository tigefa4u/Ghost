...
to the class-based service (token cleanup, gift cleanup, update checks, media
inlining, content imports, webmentions, newsletter sending) run in-process and
share the main process's initialized services.
