...
describe('GiftService', function () {
    ...
    function createService(overrides: {
        ...
        signAdminToken?: sinon.SinonStub | null;
        ...
        return new GiftService({
            ...
            signAdminToken: overrides.signAdminToken ?? null,
    ...
    describe('scheduleReminder (via redeem)', function () {
        ...
        function buildSchedulerDeps() {
            ...
            const signAdminToken = sinon.stub().returns('signed-token');
        ...
        it('schedules a reminder 7 days before consumes_at after redeem commits', async function () {
            ...
            sinon.assert.calledOnceWithExactly(deps.signAdminToken, {
        ...
        it('logs but does not throw when signAdminToken throws', async function () {
            stubRedeemer();
            ...
            const deps = buildSchedulerDeps();
            deps.signAdminToken.throws(new Error('JWT signing failed'));
