...
const bulkOperations = require('../../../../../../core/server/models/base/plugins/bulk-operations');
const {byNQL} = bulkOperations;
...
describe('Models: bulk-operations plugin', function () {
    ...
    describe('byColumnValues', function () {
        ...
        it('chunks values into groups of 100 by default', function () {
            const {byColumnValues} = bulkOperations;
