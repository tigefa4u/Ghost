...
describe('Front-end gift links', function () {
    ...
    beforeAll(async function () {
        ...
        token = (await giftLinksService.commands.ensure({actor: null}, paidPost.id)).giftLinks[0].token;
        pageToken = (await giftLinksService.commands.ensure({actor: null}, paidPage.id)).giftLinks[0].token;
