...
function flattenAutomation(automation, email = automation.related('welcomeEmailAutomatedEmail'), designSettings = email.related('emailDesignSetting')) {
    const senderSource = designSettings?.id ? designSettings : email;
    const result = {
        id: automation.id,
        ...
        sender_name: senderSource.get('sender_name'),
        sender_email: senderSource.get('sender_email'),
        sender_reply_to: senderSource.get('sender_reply_to'),
